 ...
 */
public class NHLog {
    public static final boolean LOG_TOGGLE = Constant.DEBUG;
    public static final boolean thread_toggle = true;
	private static final String LOG_FILE = Environment.getExternalStorageDirectory().getPath() + "nh_log.txt";
    ...
    public static void v(String msg, Object... params) {
        ...
        Timber.v(formatMessage(msg, params));
    }
...
//            return;
//        }
//        Timber.tag(TAG).v(formatMessage(format, params));
//    }
    ...
    public static void d(String msg, Object... params) {
        ...
        Timber.d(formatMessage(msg, params));
    }
...
//			return;
//		}
//        Timber.tag(TAG).d(formatMessage(format, params));
//	}
    ...
    public static void i(String msg, Object... params) {
        ...
        Timber.i(formatMessage(msg, params));
    }
...
//            return;
//        }
//        Timber.tag(TAG).i(formatMessage(format, params));
//    }
    ...
    public static void w(String msg, Object... params) {
        ...
        Timber.w(formatMessage(msg, params));
    }
...
////        Logger.t(TAG).w(logInfo);
//        Timber.tag(TAG).w(formatMessage(logInfo));
//	}
    ...
    public static void e(String msg, Object... params) {
        ...
        Timber.e(formatMessage(msg, params));
    }
...
//        Logger.t(TAG).e(e, msg);
        Timber.e(e, formatMessage(msg, params));
	}
