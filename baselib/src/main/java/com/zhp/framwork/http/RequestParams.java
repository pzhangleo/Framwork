...
//        }
    ...
    /**
     * Adds files array to the mRequest.
     *
     * @param key   the key name for the new param.
     * @param files the files array to add.
     * @throws FileNotFoundException if one of passed files is not found at time of assembling the requestparams into mRequest
     */
    ...
    /**
     * Adds files array to the mRequest with both custom provided file content-type and files name
     *
     * @param key            the key name for the new param.
     * @param files          the files array to add.
