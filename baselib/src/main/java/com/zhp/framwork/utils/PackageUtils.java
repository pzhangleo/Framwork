...
/**
 * Created by zhangpeng on 16/2/19.
 */
public class PackageUtils {
     ...
     * <li>You should add <strong>android.permission.INSTALL_PACKAGES</strong> in manifest, so no need to mRequest root
     ...
     * <strong>Attentions:</strong>
     * <li>Don't call this on the ui thread, it may costs some times.</li>
     * <li>You should add <strong>android.permission.DELETE_PACKAGES</strong> in manifest, so no need to mRequest root
     * permission, if you are system app.</li>
     * </ul>
     *
